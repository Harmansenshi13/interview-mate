...
export function meta({}: Route.MetaArgs) {
  return [{ title: "InterviewMate | About us" }];
}
          ...
          >
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                At InterviewMate, we believe everyone deserves the opportunity to
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Meet the expert behind InterviewMate
            </p>
          </motion.div>
          <div className="flex justify-center">
            <div className="bg-white p-6 rounded-lg shadow-md max-w-sm">
              <img
                src="https://avatars.githubusercontent.com/u/105844284?s=400&u=e930be1ab75e362fb5394d7e910bc84f9521b0b2&v=4"
                alt="Team Member"
